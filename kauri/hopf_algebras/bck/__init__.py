...
"""
The ``kauri.hopf_algebras.bck`` sub-package implements the Butcher-Connes-Kreimer (BCK) :cite:`connes1999hopf` Hopf algebra
...
from kauri.hopf_algebras.bck.bck import antipode, coproduct, counit, map_power, map_product
