...
from kauri.maps import sign
from kauri.rk import RK, _rk_symbolic_weights_map, rk_order_cond
from kauri.rk_ansatz import Ansatz, IdentityAnsatz
...
class RKMakerResult:
    ...
    def format(
        ...
        from kauri.rk_maker_format import result_to_text
    ...
    def to_latex(
        ...
        from kauri.rk_maker_format import result_to_latex
